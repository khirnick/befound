...
#include "../Admin-Qt-client/settingswindow.h"
...
QT_MOC_LITERAL(1, 15, 12), // "signalAccept"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 6) // "accept"

    },
    "SettingsWindow\0signalAccept\0\0accept"
};
...
void SettingsWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&SettingsWindow::signalAccept)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void SettingsWindow::signalAccept()
{
