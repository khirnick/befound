...
#include "../Admin-Qt-client/auth.h"
...
QT_MOC_LITERAL(1, 5, 13), // "authorisation"
QT_MOC_LITERAL(2, 19, 0), // ""
QT_MOC_LITERAL(3, 20, 5), // "login"
QT_MOC_LITERAL(4, 26, 8), // "password"
QT_MOC_LITERAL(5, 35, 7) // "loggout"

    },
    "Auth\0authorisation\0\0login\0password\0"
    "loggout"
};
...
void Auth::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->authorisation((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->loggout(); break;
        default: ;
        }
        ...
        {
            typedef void (Auth::*_t)(QString , QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Auth::authorisation)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Auth::authorisation(QString _t1, QString _t2)
{
