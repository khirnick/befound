...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        # TODO: Написать АККУРАТНУЮ генерацию координат, чтоб растояние между 2мя точками не было 5км :), и чтоб время между соседними координатами было в пределе 1сек
        # TODO: Должны быть сгенерированы пользователи со статусами ТРЕВОГА (status = 1)
